        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-title">
                    <!--begin::Search-->
                    <form class="navbar-search form-inline mb-4 w-50 d-flex" action="{{ route('admin.product.search') }}"
                        method="get">
                        @csrf
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        @foreach ($products as $product)
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            ...
                                            <a href="" class="text-gray-800 text-hover-primary fs-5 fw-bolder"
                                                data-kt-ecommerce-product-filter="product_name">{{ $product->title['en'] }}</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">{{ $product->product_category->title['en'] }}</span>
                                </td>
