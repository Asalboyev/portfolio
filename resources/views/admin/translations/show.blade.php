            ...
            <div class="card-rounded bg-light d-flex flex-stack flex-wrap p-5">
                ...
                <ul class="nav flex-wrap border-transparent fw-bolder">
                    ...
                    @foreach ($groups as $key =>$subGroup)
                        <li class="nav-item my-1">
                            <a class="btn btn-color-gray-600 btn-active-white btn-active-color-primary fw-boldest fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase @if($id == $subGroup->id)   show @endif"
                                href="{{ route('admin.group.show', $subGroup) }}">
                                {{ $subGroup->name }}
                            </a>
                        </li>
                    @endforeach
                    {{-- <a href="{{ route($currentRoute->getName()) }}" class="btn {{ $buttonClass }}">Back to {{ $currentRoute->getName() }}</a> --}}
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-title">
                        ...
                        <form class="navbar-search form-inline mb-4 w-50 d-flex"
                            action="{{ route('admin.translation.search') }}" method="get">
                            @csrf
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            @foreach ($translations as $translation)
                                <tr>
                                    ...
                                    @foreach ($languages as $language)
                                    <td>{{ $translation->val[$language->small] ?? null }}</td>
                                @endforeach
                                    <td>
                                        <form class=""
