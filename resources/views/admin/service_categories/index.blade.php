                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <form class="navbar-search form-inline mb-4 w-50 d-flex"
                                    action="{{ route('admin.service_categories.search') }}" method="post">
                                    @csrf
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                                        <span class="svg-icon svg-icon-1 position-absolute ms-4">
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td> <span class="tags">
                                            @if ($category->service_categories->isNotEmpty())
                                                @foreach ($category->service_categories as $subcategory)
                                                    <span><a
                                                            href="{{ route('admin.service_categories.edit', $subcategory->id) }}">{{ $subcategory->title['en'] }}</a></span>
                                                @endforeach
                                            @else
                                                <p> NO Categories</p>
                                            @endif
                                        ...
                                        <td>
                                            <form class=""
                                                action="{{ route('admin.service_categories.destroy', $category->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
            ...
            <div class="toolbar" id="kt_toolbar">
                ...
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ route('admin.service_categories.create') }}" class="btn btn-sm btn-primary">Create</a>
                        <!--end::Primary button-->
                    </div>
                    <!--end::Actions-->
                </div>
