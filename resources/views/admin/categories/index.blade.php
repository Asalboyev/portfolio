                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <form class="navbar-search form-inline mb-4 w-50 d-flex"
                                    action="{{ route('admin.categories.search') }}" method="post">
                                    @csrf
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                                        <span class="svg-icon svg-icon-1 position-absolute ms-4">
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('storage/'.($category->photo ?? 'default.jpg')) }}" width="50">
                                            {{ $category->title['en'] }}
                                        </td>
                                        ...
                                        <td> <span class="tags">
                                            @if ($category->categories->isNotEmpty())
                                                @foreach ($category->categories as $subcategory)
                                                    <span><a
                                                            href="{{ route('admin.categories.edit', $subcategory->id) }}">{{ $subcategory->title['en'] }}</a></span>
                                                @endforeach
                                            @else
                                                <p> NO Categories</p>
                                            @endif
