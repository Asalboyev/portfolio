                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title[{{ $language->small }}]"
                                                    ...
                                                    value="{{ $portfolio->title[$language->small] }}" />
                                            ...
                                            <div>
                                                ...
                                                <textarea id="descriptions-{{ $language->small }}" name="descriptions[{{ $language->small }}]"
                                                    class="form-control ckeditor">{!! $portfolio->descriptions[$language->small] !!}</textarea>
                ...
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10"
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body  pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="photo" id="image_name" value="{{ $portfolio->photo }}">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <input required type="text" class="form-control mb-2" name="url" value="{{$portfolio->url}}"
                                   placeholder="link..">
                        </div>
                        <div class="card-header">
                            <!--begin::Card title-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select name="tags[]" class="form-select mb-2" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple">
                                @foreach($tags as $tag)
                                    <option @if(in_array($tag->id, $portfolio->tags->pluck('id')->toArray())) selected @endif @if(in_array($tag->id, $portfolio->tags->pluck('id')->toArray())) selected @endif value="{{ $tag->id }}"value="{{$tag->id}}">{{$tag->name}}</option>
                                @endforeach
                            </select>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var myDropzone = new Dropzone("#my-dropzone", {
                ...
                maxFilesize: 6, // maksimal fayl hajmi (MB)
