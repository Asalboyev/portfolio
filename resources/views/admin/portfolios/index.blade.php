        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-title">
                    <!--begin::Search-->
                    <form class="navbar-search form-inline mb-4 w-50 d-flex" action="{{ route('admin.portfolio.search') }}"
                        method="get">
                        @csrf
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    <div class="w-100 mw-150px">
                        <!--begin::Select2-->
                        <form id="searchForm" action="{{ route('admin.portfolio.status') }}" method="post">
                            @csrf
                            <!--end::Svg Icon-->
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        @foreach ($portfolios as $portfolio)
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a class="symbol symbol-50px">
                                            ...
                                            @elseif (pathinfo($portfolio->photo, PATHINFO_EXTENSION) == 'pdf')
                                                <embed src="{{ asset('storage/' . ($portfolio->photo ?? 'default.jpg')) }}"
                                                    type="application/pdf" width="90%" height="150px" />
                                            @endif
                                            <div class="ms-5">
                                                <!--begin::Title-->
                                                <a class="text-gray-800
                                                    text-hover-primary fs-5 fw-bolder"
                                                    data-kt-ecommerce-product-filter="product_name">{{ $portfolio->title['en'] }}</a>
                                                <!--end::Title-->
                                            </div>
                                        </a>
                                    </div>
                                ...
                                <td >
                                    <span class="fw-bolder ms-3">@foreach($portfolio->tags as $tag)
                                                                     {{$tag->name}}
                                            @endforeach</span>
                                </td>
