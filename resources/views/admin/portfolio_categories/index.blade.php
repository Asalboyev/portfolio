                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <form class="navbar-search form-inline mb-4 w-50 d-flex"
                                    action="{{ route('admin.portfolio_categories.search') }}" method="post">
                                    @csrf
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                                        <span class="svg-icon svg-icon-1 position-absolute ms-4">
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('storage/' . ($category->photo ?? 'default.jpg')) }}"
                                                width="50">
                                        ...
                                        <td>
                                            <form class=""
                                                action="{{ route('admin.portfolio_categories.destroy', $category->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                ...
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    ...
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                        ...
                        <a href="{route('admin.portfolio_categories.index')}}"
                            class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Portfolio Category</a>
                        <!--end::Title-->
                        <!--begin::Separator-->
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ route('admin.portfolio_categories.create') }}"
