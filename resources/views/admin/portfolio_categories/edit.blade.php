...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="" action="{{ route('admin.portfolio_categories.update', $portfolio_category->id) }}"
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title[{{ $language->small }}]"
                                                    ...
                                                    @if ($language->small != 'en') @else value="{{ $portfolio_category->title[$language->small] }}" @endif />
...
@else{!! $portfolio_category->descriptions[$language->small] !!}
@endif </textarea>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body  pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
                                style="background-image: url({{ asset($portfolio_category->photo) }})">
