                    ...
                    <div class="card-header align-items-center py-9 gap-2 gap-md-9">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <!--end::Svg Icon-->
                                <form class="navbar-search form-inline mb-4 w-50 d-flex" action="{{ route('admin.product_categories.search') }}" method="GET">
                                    @csrf
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                                        <span class="svg-icon svg-icon-1 position-absolute ms-4">
                                ...
                                @foreach ($result as $category)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{ $category->title['en'] ?? $category->title['ru'] ?? $category->title['uz'] ?? '' }}
                                        </td>
