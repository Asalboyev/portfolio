                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <form class="navbar-search form-inline mb-4 w-50 d-flex"
                                    action="{{ route('admin.product_categories.search') }}" method="get">
                                    @csrf
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                                        <span class="svg-icon svg-icon-1 position-absolute ms-4">
                                        ...
                                        <td> <span class="tags">
                                                @if ($category->product_categories->isNotEmpty())
                                                    @foreach ($category->product_categories as $subcategory)
                                                        <span><a
                                                                href="{{ route('admin.product_categories.edit', $subcategory->id) }}">{{ $subcategory->title['en'] }}</a></span>
                                                    @endforeach
                                                @else
                                                    <p> NO Categories</p>
                                                @endif
                ...
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    ...
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                        ...
                        <a href="{route('admin.product_categories.index')}}"
                            class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Product Categories</a>
                        <!--end::Title-->
                        <!--begin::Separator-->
